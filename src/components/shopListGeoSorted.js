...
class ShopListGeoSorted extends Component {
    constructor() {
        super()
        this.state = {
          latitude: '',
    ...
    componentWillMount() {
        ...
        if (location) {
          location.getCurrentPosition((position) => {
            ...
            this.props.fetchGeolocatedShops(0 ,10 ,this.state.longitude,this.state.latitude) ;  
    ...
    renderShop() {
         return this.props.shops.geoSortedShops && this.props.shops.geoSortedShops.items.map(shop => {
...
export default connect(mapStateToProps, actions)(ShopListGeoSorted);
